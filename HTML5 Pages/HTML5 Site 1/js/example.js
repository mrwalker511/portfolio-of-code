...
$(document).ready(function(){
	...
	$("#exampleImageBox li").click(function(){
		...
		$("#exampleImageBox li.active").removeClass("active");
		...
		//Fade in elements if they are hidden due to a previous exit
	...
	doc.keyup(function(e){
		//Keyboard navigation should work only if active which means backdrop is visible.
	...
	{
		if(direction == -1) // left
			$("#exampleImageBox li.active").prev().trigger("click");
		else if(direction == 1) //right
			$("#exampleImageBox li.active").next().trigger("click");
