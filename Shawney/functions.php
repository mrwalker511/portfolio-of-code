...
function register_my_menus() {
  register_nav_menus(
    array(
      ...
      'home-side-menu' => __( 'Home Left Side Menu' ),
      'solutions-menu' => __( 'Solutions Menu' ),
      'operations-consulting-menu' => __( 'Operations Consulting Menu' ),
...
add_action('wp_print_scripts ', 'add_google_jquery');
    ...
    function responsive_child_widgets_init() {
        ...
        register_sidebar(array(
            'name' => __('Slides', 'responsive'),
            'description' => __('contact - sidebar-contact.php', 'responsive'),
            'id' => 'contact',
        ...
        register_sidebar(array(
            'name' => __('home Sidebar', 'responsive'),
            'description' => __('Area Two - sidebar-home.php', 'responsive'),
            'id' => 'home-sidebar',
            'before_title' => '<div class="widget-title">',
            'after_title' => '</div>',
            'before_widget' => '<div id="%1$s" class="widget-wrapper %2$s">',
        ...
        register_sidebar(array(
            ...
            'description' => __('Form - sidebar-form.php', 'responsive'),
            'id' => 'form-sidebar',
            'before_title' => '<div class="widget-title">',
            'after_title' => '</div>',
            'before_widget' => '<div id="%1$s" class="widget-wrapper %2$s">',
