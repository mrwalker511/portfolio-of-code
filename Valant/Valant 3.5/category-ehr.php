 ...
 <?php
 /* Template Name: Valant EHR Blog Template */
get_header();
?>
     ...
     <?php
         ...
         $more=0;
           $blog_query = new WP_Query();
            $blog_query-> query('post_type=psychiatrist&post_status=publish&posts_per_page=10&category_name='.$pagename);?>
         <?php 
     ...
     <?php if(in_category('group') or in_category('therapist') or in_category('psychiatrist') or in_category('valant-module')) 
       ...
       ?>
                           ...
                           <!-- The Post Excerpt (the Module Feature Description Excerpt -->
                                ...
                                <div class="p16 gray primary2" style="letter-spacing: 0.01em;line-height: 23px;">
                                    <?php the_content(); ?>
                                 </div>
